    ...
    def run (self, player_score: list[int]):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_text(14, f'Player 1 - Health: {ent.health} | Socore: {ent.score}', C_GREEN, (10, 25))
                if ent.name == 'Player2':
                    self.level_text(14, f'Player 2 - Health: {ent.health} | Socore: {ent.score}', C_GREEN, (10, 45))
